...
def metaFile():
    if condVisibility('System.HasAddon(script.entire.metadata)'):
        return os.path.join(xbmcaddon.Addon('script.entire.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
