...
if action == None:
    from resources.lib.indexers import entire
    entire.indexer().root()

elif action == 'directory':
    from resources.lib.indexers import entire
    entire.indexer().get(url)

elif action == 'qdirectory':
    from resources.lib.indexers import entire
    entire.indexer().getq(url)

elif action == 'xdirectory':
    from resources.lib.indexers import entire
    entire.indexer().getx(url)

elif action == 'developer':
    from resources.lib.indexers import entire
    entire.indexer().developer()

elif action == 'tvtuner':
    from resources.lib.indexers import entire
    entire.indexer().tvtuner(url)

elif 'youtube' in str(action):
    from resources.lib.indexers import entire
    entire.indexer().youtube(url, action)

elif action == 'play':
    from resources.lib.indexers import entire
    entire.player().play(url, content)

elif action == 'browser':
    from resources.lib.indexers import entire
    entire.resolver().browser(url)

elif action == 'search':
    from resources.lib.indexers import entire
    entire.indexer().search()

elif action == 'addSearch':
    from resources.lib.indexers import entire
    entire.indexer().addSearch(url)

elif action == 'delSearch':
    from resources.lib.indexers import entire
    entire.indexer().delSearch()
